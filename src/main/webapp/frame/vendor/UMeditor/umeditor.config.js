...
(function () {
     ...
     */
    window.UMEDITOR_HOME_URL = rootPath + "/static/com/zjzy/plugins/UMeditor/";
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl: rootPath + "/FileUpLoad/"             //图片上传提交地址
        ,imagePath: rootPath + "/static"                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
