(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        tpl: "<style type=\"text/css\">" +
            ...
            " } }" +
            "</scr_ipt>" +
            "<scr_ipt onreadystatechange='mapReadyStateChange(this.readyState);' onload='mapReadyStateChange(\"loaded\");' src=\"http://api.map.baiduEditor.com/api?v=2.0&ak=6b6c1a67eaa7db1ca6d6da28e590e343&services=true\"></scr_ipt>" +
            "</body>" +
            "</html>" +
            "</script>",
            ...
            ok: {
                exec: function (editor) {
                    ...
                    if (widget.root().find(".edui-map-dynamic")[0].checked) {
                        ...
                        url = "http://api.map.baiduEditor.com/staticimage?center=" + center.lng + ',' + center.lat +
